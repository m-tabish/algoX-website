...
import Shashwat from "../assets/Shashwat.jpg"
...
export const teamMembers = [
	...
	},
	{
		...
		social: {
			...
			github: "https://github.com/Kaustubh-2003",
			linkedin: "https://www.linkedin.com/in/kaustubhhpandey/",
			twitter: "https://x.com/Er_Kaustubh_?t=CleRovAEEeG3CtkD242VlQ&s=09"
		},
	},
	{
		name: "Ayush Kumar Shukla",
		role: "Flutter Dev, AI/ML Enthusiast",
		bio: "Upcoming Intern at Space Applications Centre,ISRO",
		image: Ayush,
	...
	}, 
	{
		...
		bio: "Eager to learn about AI & ML",
		image:Sneha,
...
>>>>>>> main
	...
	{
		name: "Harshita Singh",
		role: "Cybersecurity & Web Dev",
		bio: "Cybersecurity & AI Enthusiast, SIH'24 Finalist, 3x Hackathon Winner.",
		image:Harshita,
	...
	{
		name: "Arya Mishra",
		role: "Frontend Web Dev, Data Analyst",
		bio: "SIH'24 Finalist",
		image:Arya,
	...
	},
	{
		...
		bio: "Passionate about AI, Machine Learning and Cloud Computing, Currently working on Azure and GCP",
		image:Shashwat,
	...
	{
		name: "Ritanshu Sharma",
		role: "Frontend Web Developer, AI Enthusiast",
		bio: "Passionate about AI, Blockchain and Open-Source, Empowering innovation through learning and leadership, Selected as Google Cloud Arcade Fecilitator 2025",
		image:Ritanshu,
	...
	{
		name: "Vivek Yadav",
		role: "Cybersecurity, Frontend Dev",
		bio: "Passionate about Cybersecurity, Frontend dev, building secure, responsive, and user-friendly web experiences.",
		image:Vivek,
	...
	{
		name: "Rashi Malik",
		role: "Aspiring Data Analyst & AI Enthusiast, Frontend Dev, Content Creator",
		bio: "IBM DS & AI Specialization, Passionate Learner, Strong Communication and Anchoring Skills",
		image:Rashi,
	...
	},
	{
		...
		bio: "Four-Fold Code Quest Winner, Specialised in Data Science",
		image:Muskan,
